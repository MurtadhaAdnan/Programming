...
اعتبر مشكلة ماكينات ذات أذرع متعددة $$k$$ حيث $$k=4$$ أفعال، والتي يُرمز لها بـ 1، 2، 3، و4. افترض تطبيق خوارزمية ماكينات ذات أذرع متعددة باستخدام اختيار الأفعال بطريقة $$\varepsilon$$-greedy، وتقديرات قيمة الأفعال باستخدام المتوسط الحسابي للعينات، وتقديرات أولية ل$$Q_1(a) = 0$$ لجميع $$a$$.

لتكن سلسلة الأفعال والمكافآت كالآتي:  
الخطوة الزمنية $$t=1$$، $$A_1=1$$، $$R_1=-1$$  
الخطوة الزمنية $$t=2$$، $$A_2=2$$، $$R_2=1$$  
الخطوة الزمنية $$t=3$$، $$A_3=2$$، $$R_3=-2$$  
الخطوة الزمنية $$t=4$$، $$A_4=2$$، $$R_4=2$$  
الخطوة الزمنية $$t=5$$، $$A_5=3$$، $$R_5=0$$  

احسب قيمة $$Q_6(2)$$ و$$Q_6(1)$$ بعد الخطوة 5.
